...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _components_cards__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/cards */ \"./src/components/cards.js\");\n/* harmony import */ var _components_inbox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/inbox */ \"./src/components/inbox.js\");\n/* harmony import */ var _components_project_methods__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/project-methods */ \"./src/components/project-methods.js\");\n\n\n\n\n\nconst tasksPlace = document.querySelector('.tasks-place');\nconst inbox_btn = document.getElementById('inbox-side-btn');\nconst projects = document.querySelectorAll('.project');\nconst mainDiv= document.querySelector('main');\nconst project_btn = document.querySelector('.add-project');\nconst popup = document.getElementById('popup');\nconst close_btn = document.getElementById('close');\nclose_btn.addEventListener('click', () => {\n  popup.classList.add('hidden');\n});\n\n\nlet tasklist = new _components_cards__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n\n\nfunction main() {\n  tasklist.addTask((0,_components_inbox__WEBPACK_IMPORTED_MODULE_1__.addTask)(tasklist));\n  tasklist.looponlist();\n  popup.classList.add('hidden');\n}\n\nconst submit = document.querySelector('.submit');\n\nsubmit.onclick = main;\ninbox_btn.onclick = () => {\n  (0,_components_inbox__WEBPACK_IMPORTED_MODULE_1__.loadInbox)();\n  tasklist.looponlist();\n}\n\nprojects.forEach(project => {project.addEventListener('click', e => {\n  project_tasklist = new _components_cards__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n  let name = e.target.textContent;\n  mainDiv.textContent = '';\n  (0,_components_project_methods__WEBPACK_IMPORTED_MODULE_2__.makeProject)(name);\n})});\n\nproject_btn.onclick = _components_project_methods__WEBPACK_IMPORTED_MODULE_2__.addProject;\n\n(0,_components_inbox__WEBPACK_IMPORTED_MODULE_1__.loadInbox)();\n\n\n//# sourceURL=webpack://to-do/./src/index.js?");
